  ...
  return (
    <Container component="main">
      ...
      <Typography variant="body1">
        ...
        characterization using optical vibrational spectroscopy and provide insight into the local order present in low symmetry and
        amorphous samples. Machine learning is the perfect tool to develop these correlations because of the multidimensional nature of the
        structural and spectroscopic datasets. To address the small data challenge, training data for SSM will be collected into CURIES, a
        compendium of Raman and infrared experimental spectra of uranium oxide materials. CURIES and SSM will enable identification of new
        signatures that can be leveraged to support material characterization for nonproliferation and to provide additional knowledge about
        a given sample history. SSM will be developed with end-users in mind by integrating the machine learning framework with secure
